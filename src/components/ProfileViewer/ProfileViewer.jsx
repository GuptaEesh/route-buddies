...
const ProfileViewer = ({
  ...
  return (
    <div className=" rounded m-4 flex flex-col w-[90%] shadow-lg py-4 px-5  bg-white">
      <div className="flex sm:flex-row flex-col sm:m-0 m-auto items-start justify-between">
        ...
        <p className="pt-4 text-xs leading-4 sm:m-0 m-auto text-gray-600">
          {userStatus}
        </p>
      </div>
      <div className="flex items-center justify-between w-full sm:px-24 pt-6">
        <div className="sm:block hidden w-full items-center">
          <div className="w-full h-2 h-64 bg-gray-100 flex flex-row items-center justify-between">
