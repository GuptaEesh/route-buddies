...
const ProfileViewer = ({id="fddf",userImg="https://tuk-cdn.s3.amazonaws.com/assets/components/avatars/a_5.png",userName="dummyUser",designation="Professional",userStatus="New in the city",source="Karnal",destination="Delhi"}) => {
  return (
      ...
      <div className=" rounded m-4 flex flex-col w-[90%] shadow-lg py-4 px-5  bg-white">
                    ...
                    <div className="m-2 sm:block hidden mx-16">
                        <div className="flex items-center justify-between">
                            <div className="flex flex-col items-center">
                                <p className="text-sm font-medium leading-4 text-indigo-700 ">{source}</p>
                                
                            </div>
                            <div className="flex flex-col items-center pl-10 md:pl-8 lg:pl-20">
                                <p className="text-sm font-medium leading-4 text-indigo-700">{destination}</p>
                            </div>
        ...
        <div className="flex items-end justify-center">
          <Link to={`/explore/${id}`} className=" text-xs font-medium leading-3 text-white py-3 px-4 rounded bg-indigo-700 focus:outline-none hover:opacity-90">
            Open Profile Page
          </Link >
        </div>
      </div>
